		...
		public static void generateRoom(int x, int y, int doorWeight)
			{
				...
				map[x][y] = new Room(x, y, roomType, doors, null, description);
		...
		public static String[] generateDoors(int x, int y, int doorWeight)
			{
				...
				// System.out.println("setting rooms to random for room at"+x+",
				// "+y);
				...
				// System.out.println("Rands doors
				...
				try {
					...
					// System.out.println("No room existed north, door not
					// made");
				...
				try {
					...
					// System.out.println("No room existed west, door not
					// made");
				...
				try {
					...
					// System.out.println("No room existed south, door not
					// made");
				...
				try {
					...
					// System.out.println("No room existed east, door not
					// made");
